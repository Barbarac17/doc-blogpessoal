...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">blogpessoalbabi documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-36cc43eb27cc79558bc340c01302d1b8"' : 'data-target="#xs-components-links-module-AppModule-36cc43eb27cc79558bc340c01302d1b8"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-36cc43eb27cc79558bc340c01302d1b8"' :
                                            'id="xs-components-links-module-AppModule-36cc43eb27cc79558bc340c01302d1b8"' }>
                                            <li class="link">
